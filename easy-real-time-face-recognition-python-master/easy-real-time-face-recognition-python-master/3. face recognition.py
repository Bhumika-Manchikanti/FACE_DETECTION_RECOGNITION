...
names = ['','sudheer','bhumi']  #key in names, start from the second place, leave first empty
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        id, confidence = recognizer.predict(gray[y:y+h,x:x+w])    #shows the number of the person in training set and confidence for it for all persons in the training set with a confidence value
